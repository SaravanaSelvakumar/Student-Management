...
<body>
	<div class="wrapper">
		<form action="AdminAttendence" method=post>
			<h1>Student Enrollment List</h1>


			<div class="input-box">
				<label>Registration Number : </label> <input type="text"
					name="Registration" placeholder="Registration Number" required>
			</div>
			...
			<div class="input-box">
				<label>Student Name : </label> <input type="text" name="Student"
					placeholder="Student Name" required>
			</div>

			<div class="input-box">
				<label>Staff Name : </label> <input type="text" name="Staff"
					placeholder="Staff Name" required>
			</div>

			
			<div class="input-box">
				<label>Semster : </label> <input type="text" name="Semster"
					placeholder="Semster" required>
			</div>

			<div class="input-box">
				<label>Percentage : </label> <input type="text" placeholder="Percentage"
